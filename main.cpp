...
void ModifierRDV()
{
	...
	if ((int)etudiant->getListeRdvs().size() == 0)
	{
		cout << "Auncun rendez-vous trouvé" << endl;
		return;
	}
...
void remplirBDD()
{
	...
	new EtudiantCycle1(1,"Dupont","Julie","Limoges","0615489562", 2015, "Raoul Dautry", "S");
		...
		new RDV(new Date(12,10,2019), new Heure(9,5), new Heure(9,20), Etudiant::getEtudiants().back(), Entreprise::getEntreprises().front());
	...
	new EtudiantCycle1(2,"Dupond","Martin","Rennes","0651021484", 2015, "Limosin", "ES");
		...
		new RDV(new Date(2,2,2019), new Heure(15,10), new Heure(15,25), Etudiant::getEtudiants().back(), Entreprise::getEntreprises().front());
	...
	new EtudiantCycle1(3,"Depardeut","Gerard","Strasbourg","0748650141", 2015, "Saint Joseph", "L");
		...
		new RDV(new Date(25,5,2019), new Heure(8,0), new Heure(8,15), Etudiant::getEtudiants().back(), Entreprise::getEntreprises().front());
	...
	new EtudiantCycle1(4,"Jerry","Justine","Marseille","0636051490", 2015, "Valadon", "STMG");
		...
		new RDV(new Date(1,3,2019), new Heure(18,0), new Heure(19,0), Etudiant::getEtudiants().back(), Entreprise::getEntreprises().front());
	...
	new EtudiantCycle2(5,"Jidor","Kylian","Lille","0615410231", "Info");
		...
		new RDV(new Date(3,3,2018), new Heure(6,0), new Heure(6,10), Etudiant::getEtudiants().back(), Entreprise::getEntreprises().back());
	...
	new EtudiantCycle2(6,"Mushu","Mathilde","Rouen","0748956215", "SVT");
		...
		new RDV(new Date(10,6,2018), new Heure(13,0), new Heure(13,5), Etudiant::getEtudiants().back(), Entreprise::getEntreprises().back());
	...
	new EtudiantCycle2(7,"Vades","Victor","Limoges","0630254777", "Mathematiques");
		...
		new RDV(new Date(11,8,2018), new Heure(16,0), new Heure(16,20), Etudiant::getEtudiants().back(), Entreprise::getEntreprises().back());
	...
	new EtudiantCycle2(8,"Pluchon","Lea","Agen","0730514895", "Petite Enfance");
		...
		new RDV(new Date(8,12,2018), new Heure(7,0), new Heure(7,12), Etudiant::getEtudiants().back(), Entreprise::getEntreprises().back());
